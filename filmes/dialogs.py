...
def add_movie_dialog(app):
    dialog = BaseDialog(
        ...
        buttons=[
            CancelButton(),
            OkayButton(on_release=app.add_movie_from_dialog),
        ]
    )
...
def edit_movie_dialog(app, obj):
    ...
    dialog = BaseDialog(
        ...
        buttons=[
            CancelButton(),
            OkayButton(on_release=lambda x: app.edit_callback(filme)),
        ]
    )
...
def movie_detail_dialog(app, obj):
    ...
    dialog = BaseDialog(
        ...
        buttons=[
            ...
            OkayButton(
                text="EDITAR",
                on_release=lambda x: app.movie_detail_callback(filme)
            ),
        ]
    )
